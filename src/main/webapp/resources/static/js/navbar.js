        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="item/shop.html">毛孩の商城</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">團購底加啦</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="article/select_page.jsp">家長討論區</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="mem/login.jsp">成為會員 / 登入會員</a></li>
                            <li><a class="dropdown-item" href="commodityDetails/OrderDetail.html">追蹤訂單</a></li>
