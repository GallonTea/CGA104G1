...
public class Group_Buy_OrderService {
	...
	public Group_Buy_OrderVO addGroup_Buy_Order_User(Integer gbitem_id,Integer gbitem_amount,Integer gboriginal_price,
			Integer discount_id,Integer gb_endprice,Integer gborder_paying,Integer gborder_send,
			Integer gborder_status,String gborder_other,String receiver_name,String receiver_address,
			String receiver_phone,Timestamp gborder_date,Integer gborder_id) {
	...
	public Group_Buy_OrderVO updateGroup_Buy_Order(Integer gborder_id, Integer gbitem_id,Integer gb_id,Integer gbitem_amount,
			Integer gboriginal_price,Integer discount_id,Integer gb_endprice,Integer gborder_paying,
			Integer gborder_send,Integer gborder_status,String gborder_other,String tracking_num,String receiver_name,
			String receiver_address,String receiver_phone , Timestamp gborder_date,Timestamp pickup_time) {
