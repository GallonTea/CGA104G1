...
<!-- 	ACTION="/CGA104G1/Group_JoinServlet" -->	
			...
			<tr>
				...
				<td><input  class="field" type="number" name="gbbuy_amount" min="1" max="${group_joinVO.group_BuyVO.gb_min - nowamount}" required
				 size="45"
					...
					<input    class="field2"  type="button"  value="計算價格" onclick="price()"><font color=red>${errorMsgs.gbbuy_amount}</font>
			</tr>
		...
		<div id ="yesboss">	<input  class="btn btn-warning" type="button"  value="確認修改"  onclick="update()"></div>
	</FORM>
