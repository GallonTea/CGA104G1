...
<body>
	<h4>
		<a
			href="<%=request.getContextPath()%>//frontend/groupBuy/listallgroupbuuy.jsp">回首頁</a>
	</h4>
	<h4>
		<a
			href="<%=request.getContextPath()%>/frontend/groupBuy/mygroupbuyapplylist.jsp">團購主的團購團</a>
	</h4>
